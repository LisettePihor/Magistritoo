...
def main():
    ...
    unique_molecules(df_new, 'data/heatmap_molecules.png')

    X_train0, y_train0, X_test0, y_test0 = create_data(0)
    plot_dist(y_train0, y_test0, "juhuslik_kombo_0")
    ...
    plot_dist(y_train0_ordered, y_test0_ordered, "järjestatud_kombo_0")
    ...
    plot_dist(y_train1, y_test1, "juhuslik_kombo_1")
    ...
    plot_dist(y_train1_ordered, y_test1_ordered, "järjestatud_kombo_1")
